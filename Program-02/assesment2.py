...
# 1.Create an Empty Shopping List: Make a new shopping list.           
# 2.Add Items: Use a function to add items to the list.          
# 3.Remove Items:Write a function to delete a chosen item.
...
# Fetch products from API "https://fakestoreapi.com/products?limit=5"
...
add_item(product_names[0])
add_item(product_names[1])
add_item(product_names[2])
add_item(product_names[3])
add_item(product_names[4])
